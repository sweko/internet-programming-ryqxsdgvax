...
1. Go to the exam repository page: [https://github.com/sweko/internet-programming-ryqxsdgvax](https://github.com/sweko/internet-programming-ryqxsdgvax)
...
3. Go to your GitHub account and open the forked repository. The URL should be something like `https://github.com/<your-user-name-here>/internet-programming-ryqxsdgvax`
...
4. Open a terminal and run the following command: `git clone <url-of-the-repository>`. This will create a local copy of the repository on your computer. The URL should be something like `https://github.com/<your-user-name-here>/internet-programming-ryqxsdgvax.git`
